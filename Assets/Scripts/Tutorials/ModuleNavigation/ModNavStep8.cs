...
{
    /// <summary>
    /// The step 8 of the Tutorial on Modules Navigation.
    /// Add a GroupBy Module and make groups.
    /// </summary>
    public class ModNavStep8 : Step
    {
        ...
        public override void Initialize()
        {
            ...
            guiManager.refModulesMenuManager.SwitchSingleInteractibility(5);
            targetButton = guiManager.refModulesMenuManager.targetGroup[5].GetComponent<Button>();
