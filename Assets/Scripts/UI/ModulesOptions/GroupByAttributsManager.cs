...
namespace ECellDive.UI
{
	...
	{
		/// <summary>
		/// Reference to the GroupByModule that this GUI is attached to.
		/// </summary>
		public GroupByModule refGroupByModule;

		/// <summary>
		/// Reference to the scroll list that will display the attributs
		/// that can be used to group the data.
		/// </summary>
		...
		/// <summary>
		/// The list of the drop down containers that will hold the attributs
		/// that can be used to group the data.
		/// </summary>
