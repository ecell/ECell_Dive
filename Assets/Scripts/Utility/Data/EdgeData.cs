...
namespace ECellDive.Utility.Data.Graph
{
	...
	/// </summary>
	[System.Serializable]
	public struct CyJsonEdge : IEdge
	{
		#region - IEdge Fields -
		/// <summary>
		/// The field for <see cref="ID"/>.
		...
		/// <summary>
		/// The name of the reaction this edge represents.
		/// </summary>
		public string reactionName;

		public CyJsonEdge(uint _ID, string _name, string _reactionName, uint _source, uint _target)
		{
			m_ID = _ID;
			m_source = _source;
			m_target = _target;
